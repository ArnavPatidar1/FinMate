...
public class CategoryAdapter2 extends RecyclerView.Adapter<CategoryAdapter2.CategoryViewHolder> {
    ...
    public CategoryAdapter2(Context context, ArrayList<CategoryModel> categories, CategoryClickListener categoryClickListener) {
    ...
    public CategoryViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.sample_category2, parent, false);
